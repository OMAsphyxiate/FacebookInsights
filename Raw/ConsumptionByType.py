...
FileName = Connect.FilePath + "ConsumptionByType.txt"
...
for item in Connect.UserList:
    ...
    for post in posts['data']:
        ...
        for value in post['values']:
            ...
            Functions.WriteFile('ConsumptionByType', str(item), var1,var2,var3,var4,var5,var20,var21,var22,var23,var24,var25)
