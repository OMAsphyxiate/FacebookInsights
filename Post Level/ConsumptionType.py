...
FileName = Connect.FilePath + "ConsumptionType.txt"
...
for item in Connect.UserList:
    ...
    for post in posts['data']:
        ...
        try:
            ...
            var11 = 0
        Functions.WriteFile('ConsumptionType', str(item),var1,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11) #Write data to file