...
FileName = Connect.FilePath + "NegativeFeedbackType.txt"
...
for item in Connect.UserList:
    ...
    for post in posts['data']    :
        ...
        Functions.WriteFile('NegativeFeedbackType', str(item),var1,var2,var3,var4,var5,var6,var7,var8,var9,var10) #Write data to file
